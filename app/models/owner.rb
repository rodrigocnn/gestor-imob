class Owner < ApplicationRecord
   has_many :properties
    before_destroy :prevent_destroy_if_has_properties
    ...
    def prevent_destroy_if_has_properties
          if properties.exists?
            errors.add(:base, "Este proprietário está vinculado a um imóvel e não pode ser excluído.")
            throw :abort
          end
    end
end
